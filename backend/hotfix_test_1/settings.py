"""
Django settings for hotfix_test_1 project.
...
ROOT_URLCONF = 'hotfix_test_1.urls'
...
WSGI_APPLICATION = 'hotfix_test_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hotfix_test_1 API",
    "DESCRIPTION": "API documentation for hotfix_test_1 App",
    "VERSION": "v1",
}
